from onlineTournaments.items import OnlinetournamentsItem
from scrapy import Spider, Request
import re


class OnlineTournamentsSpider(Spider):
    name = 'onlineTournaments_spider'
    allowed_urls = ['https://www.esportsearnings.com/']
    start_urls = [
        'https://www.esportsearnings.com/players/most-online-tournament-results']
